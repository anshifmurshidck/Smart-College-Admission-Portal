    ...
    <div style={{ display: isVisible ? 'contents' : 'none' }}>
      ...
      <style>{`
        ...
        .glb-chatbot-backdrop {
          ...
          z-index: 998;
          animation: glbBackdropIn 0.25s ease both;
        }
        @keyframes glbBackdropIn {
          from { opacity: 0; }
          to { opacity: 1; }
        }
        .glb-chatbot-panel {
          ...
          overflow: hidden;
          z-index: 999;
          animation: glbChatbotOpen 0.32s cubic-bezier(0.16, 1, 0.3, 1) forwards;
        }
      ...
      {isOpen && (
        <>
        <div className="glb-chatbot-backdrop" onClick={() => setIsOpen(false)} />
